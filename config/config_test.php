...
//声纹列表
$template_sw_path=$template_mk."/sw_test.html";
//声纹认证操作
...
//service地址
$service_uri='http://192.168.1.222:9002/';
//调用地址
$service_uri_function='http://192.168.1.222:9002/service/service.php';
//远程声纹识别
$service_tie_path="http://192.168.1.222:8089/voiceservice/wsdl/VoiceprintService.wsdl";
//语音地址
