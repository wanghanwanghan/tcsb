<?php
/**
 * pageft 分页函数 用法 pageft(总条数据,每页条数,带的URL参数)
 *
 * @author CaiLiWen
 * @version 0.1
 * @create date 2006-07-02
 * @last modify date 2006-07-03
 * 
 */
...
{ 
	  ...
	  {	
		    ...
		    $url_query=getFromArray($parse_url,"query",''); //单独取出URL的查询字串
		    if($url_query)
		    {
